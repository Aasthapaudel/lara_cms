...
<head>
  ...
  <!-- Ionic Icon Css -->
  <link rel="stylesheet" href="{{asset('asset/plugins/Ionicons/css/ionicons.min.css')}}">
  <!-- animate.css -->
...
<div id="scroll-to-top" class="scroll-to-top">
    ...
    <script src="{{asset('asset/plugins/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
    <!-- filter -->
    <script src="{{asset('asset/plugins/shuffle/shuffle.min.js')}}"></script>
